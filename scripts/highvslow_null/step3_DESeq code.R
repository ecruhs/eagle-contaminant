...
plotCounts(dds, gene="CA6", intgroup="LC_cat")
plotCounts(dds, gene="TMEM175", intgroup="LC_cat")
plotCounts(dds, gene="LOC104833879", intgroup="LC_cat")
plotCounts(dds, gene="RGSL1", intgroup="LC_cat")
plotCounts(dds, gene="LOC104833138", intgroup="LC_cat")
plotCounts(dds, gene="LOC104837921", intgroup="LC_cat")
